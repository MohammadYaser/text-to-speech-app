...
# 📖 Text-to-Speech-app <a name="about-project"></a>
<br>
<br>
This lightweight JavaScript application allows users to convert text into speech seamlessly. With a clean and intuitive interface, users can input any text, and the app will generate high-quality audio output in real-time.
<br>
<br>
...
- Choose a directory
- Open a Terminal
- write git clone https://github.com/MohammadYaser/text-to-speech-app.git
...
Feel free to check the [issues page](https://github.com/MohammadYaser/text-to-speech-app.git/issues).
...
<br>
<br>
[![Star](https://img.shields.io/github/stars/MohammadYaser/text-to-speech-app?style=social)](https://github.com/MohammadYaser/text-to-speech-app.git)
